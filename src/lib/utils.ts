...
export const PARAMETRIC_MODELS: ModelConfig[] = [
  ...
  },
  {
    id: 'z-ai/glm-5.1',
    name: 'GLM 5.1',
    description: 'Zhipu AI model with strong code generation capabilities',
    provider: 'Zhipu',
    supportsTools: true,
  ...
  },
  {
    ...
    name: 'DeepSeek V3.2',
    description: 'DeepSeek model with strong reasoning and code generation',
    provider: 'DeepSeek',
    supportsTools: true,
    supportsThinking: true,
    supportsVision: false,
  },
  {
    ...
    description: 'NVIDIA 120B MoE model, free tier on OpenRouter',
    provider: 'NVIDIA',
    supportsTools: true,
    supportsThinking: false,
    supportsVision: false,
  ...
  },
  {
    ...
    name: 'Qwen 3.6 Plus',
    description: 'Alibaba Qwen model with strong multi-task capabilities',
    provider: 'Qwen',
    supportsTools: true,
    supportsThinking: true,
    supportsVision: false,
  },
  {
    ...
    name: 'Trinity Large',
    description: 'Arcee AI large preview model, free tier on OpenRouter',
    provider: 'Arcee',
    supportsTools: true,
    supportsThinking: false,
    supportsVision: false,
  },
  {
    ...
    name: 'Qwen3 235B',
    description: 'Qwen3 235B MoE model with strong reasoning',
    provider: 'Qwen',
    supportsTools: true,
    supportsThinking: true,
    supportsVision: false,
  },
  {
    ...
    name: 'Step 3.5 Flash',
    description: 'StepFun fast model with efficient code generation',
    provider: 'StepFun',
    supportsTools: true,
    supportsThinking: false,
    supportsVision: false,
  },
  {
    ...
    name: 'Qwen 3.5 397B',
    description: 'Qwen 3.5 largest MoE model with top-tier reasoning',
    provider: 'Qwen',
    supportsTools: true,
    supportsThinking: true,
    supportsVision: false,
  },
  {
    ...
    description: 'Arcee AI model with extended reasoning capabilities',
    provider: 'Arcee',
    supportsTools: true,
    supportsThinking: true,
    supportsVision: false,
